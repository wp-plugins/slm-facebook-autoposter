...
/**
 * Extends the MV_BaseFacebook class with the intent of using
 * PHP sessions to store user ids and access tokens.
 */
class MV_Facebook extends MV_BaseFacebook
{
  /**
   * Cookie prefix
   */
   ...
   *
   * @see MV_BaseFacebook::__construct
   */
   ...
   * {@inheritdoc}
   *
   * @see MV_BaseFacebook::setPersistentData()
   */
   ...
   * {@inheritdoc}
   *
   * @see MV_BaseFacebook::getPersistentData()
   */
   ...
   * {@inheritdoc}
   *
   * @see MV_BaseFacebook::clearPersistentData()
   */
   ...
   * {@inheritdoc}
   *
   * @see MV_BaseFacebook::clearAllPersistentData()
   */
